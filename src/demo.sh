...
#EFSR
python main.py --model EFSR --scale 3 --n_resblocks 12 --batch_size 16 --patch_size 144 --save efsr_x3 --reset --save_results --save_models  --pre_train /home/xps/SR/model_best.pt
python main.py --model EFSR --data_test Demo --scale 3 --pre_train ../experiment/efsr_x3/model/model_best.pt --test_only --save_results --self_ensemble
--data_test Set5+Set14+B100+Urban100+Manga109
python main.py --model RCAN --data_test Demo --scale 2 --pre_train ../experiment/RCAN_BIX2_G10R20P48/model/model_best.pt --test_only --save_results
python main.py --model ECSR --scale 3 --n_dpg 30 --n_feats 128 --dir_data /home/xps/SR/dataset --batch_size 16 --patch_size 144 --save ecsr_x3 --reset --save_results --save_models 